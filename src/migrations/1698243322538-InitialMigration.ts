...
export class InitialMigration1698243322538 implements MigrationInterface {
    name = 'InitialMigration1698243322538'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "anouncements" ("id" SERIAL NOT NULL, "marca" character varying(100) NOT NULL, "modelo" character varying(100) NOT NULL, "ano" character varying(200) NOT NULL, "combustivel" character varying(200) NOT NULL, "quilometragem" character varying(200) NOT NULL, "cor" character varying(150) NOT NULL, "valor_tabela_fip" character varying(50) NOT NULL, "valor" character varying(50) NOT NULL, "descricao" character varying(2000) NOT NULL, "is_active" character varying(200) NOT NULL DEFAULT 'ativo', "img_capa" character varying(2000) NOT NULL, "userId" integer, CONSTRAINT "PK_c96a8cc85ae35a5f59b0eb0d272" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_tipo_de_conta_enum" AS ENUM('Comprador', 'Anunciante')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "nome" character varying(50) NOT NULL, "email" character varying(50) NOT NULL, "cpf" character varying(30) NOT NULL, "celular" character varying(30) NOT NULL, "data_de_nascimento" character varying(30) NOT NULL, "descricao" text, "tipo_de_conta" "public"."users_tipo_de_conta_enum" NOT NULL DEFAULT 'Comprador', "password" character varying(200) NOT NULL, "addressId" integer, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "addresses" ("id" SERIAL NOT NULL, "rua" character varying(150) NOT NULL, "cep" character varying(30) NOT NULL, "numero" character varying(7), "cidade" character varying(150) NOT NULL, "estado" character varying(2) NOT NULL, "complemento" character varying(30), CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
