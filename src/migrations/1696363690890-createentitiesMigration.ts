...
export class CreateentitiesMigration1696363690890 implements MigrationInterface {
    name = 'CreateentitiesMigration1696363690890'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comments" ("id" SERIAL NOT NULL, "descricao" character varying(150) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "anouncementId" integer, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
